...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_rgba(217,164,65,0.15)_0%,_transparent_70%)]" />
      ...
      <div className="relative z-20 container-main text-center">
        <div className="max-w-3xl mx-auto">
          {/* Eyebrow */}
          <p className="text-sm md:text-base uppercase tracking-[0.25em] text-accent mb-4 font-medium">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/events"
              className="inline-flex items-center justify-center px-8 py-3.5 rounded-full bg-primary text-white font-semibold text-base hover:opacity-90 transition-opacity duration-200 shadow-lg shadow-primary/20"
            >
              Explore Events
            ...
            <a
              href="/about"
              className="inline-flex items-center justify-center px-8 py-3.5 rounded-full border border-white/20 text-white font-semibold text-base hover:bg-white/5 transition-colors duration-200"
            >
              Our Story
            </a>
          </div>
